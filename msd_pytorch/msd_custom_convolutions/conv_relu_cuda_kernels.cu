...
template
__global__ void
conv_relu_forward<float>(mcc::UnpackableTensorAccessor<float, 4, mcc::RestrictPtrTraits, DT_INDEX> input,
			 mcc::UnpackableTensorAccessor<float, 4, mcc::RestrictPtrTraits, DT_INDEX> kernel,
			 mcc::UnpackableTensorAccessor<float, 1, mcc::RestrictPtrTraits, DT_INDEX> bias,
			 mcc::UnpackableTensorAccessor<float, 4, mcc::RestrictPtrTraits, DT_INDEX> output,
			 int dilation);
template
__global__ void
conv_relu_forward<double>(mcc::UnpackableTensorAccessor<double, 4, mcc::RestrictPtrTraits, DT_INDEX> input,
			  mcc::UnpackableTensorAccessor<double, 4, mcc::RestrictPtrTraits, DT_INDEX> kernel,
			  mcc::UnpackableTensorAccessor<double, 1, mcc::RestrictPtrTraits, DT_INDEX> bias,
			  mcc::UnpackableTensorAccessor<double, 4, mcc::RestrictPtrTraits, DT_INDEX> output,
			  int dilation);
