...
Mixed-scale Dense Networks for PyTorch could always use more documentation, whether as part of the
official Mixed-scale Dense Networks for PyTorch docs, in docstrings, or even on the web in blog posts,
articles, and such.
...
To run a subset of tests::
    ...
    $ py.test tests.test_msd_pytorch
